...
import { getClassReport } from '../../api/services/faculty/Faculty';
import { StudentOverall } from '../../api/services/hod/hod';
import { getStudentDetails } from '../../api/services/Student/Student';
